...
dfToPlot[dfToPlot$clusters %in% c(0), ]$clusters.name <- "Directed away from LV"
dfToPlot[dfToPlot$clusters %in% c(1), ]$clusters.name <- "Meandering close to LV"
dfToPlot[dfToPlot$clusters %in% c(2), ]$clusters.name <- "Meandering away from LV"
dfToPlot[dfToPlot$clusters %in% c(3), ]$clusters.name <- "Scanning in LV"
dfToPlot[dfToPlot$clusters %in% c(4), ]$clusters.name <- "Patrolling in LV"
...
summaryDF[summaryDF$clusters %in% c(0), ]$clusters.name <- "Directed away from LV"
summaryDF[summaryDF$clusters %in% c(1), ]$clusters.name <- "Meandering close to LV"
summaryDF[summaryDF$clusters %in% c(2), ]$clusters.name <- "Meandering away from LV"
summaryDF[summaryDF$clusters %in% c(3), ]$clusters.name <- "Scanning in LV"
summaryDF[summaryDF$clusters %in% c(4), ]$clusters.name <- "Patrolling in LV"
