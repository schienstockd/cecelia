...
splitTracks <- list(
  live.cell.track.clusters.wp_movement = list(
    Directed = list(values = list(2), colour = "#ff1493"),
    Crawling = list(values = list(0,3,4), colour = "#ffd700"),
    Sessile = list(values = list(1), colour = "#00bfff")
    )
  )

popsToShow <- list("Tom")

generateMovies(anaDir, cciaObj, uIDs, channelsToShow, popsToShow, NULL,
               # splitTracks = splitTracks, fps = 10, valueName = "default")
               splitTracks = splitTracks, fps = 10, generateMovie = TRUE, valueName = "corrected")
```
