...
generateMovies(anaDir, cciaObj, uIDs, channelsToShow, popsToShow, fileAttrs, splitTracks = splitTracks, generateMovie = FALSE)
```
...
generateMovies(anaDir, cciaObj, uIDs, channelsToShow, popsToShow, fileAttrs,
               splitTracks = splitTracks, generateMovie = TRUE)
```
...
splitTracks <- list(
  live.cell.track.clusters.hmm_transitions_movement = list(
    zero = list(values = list(3), colour = "#E42328"),
    one = list(values = list(1,4), colour = "#327EBA"),
    two = list(values = list(0), colour = "#4CAF48"),
    three = list(values = list(2), colour = "#974D9E")
    )
  )
