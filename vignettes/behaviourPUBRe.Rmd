...
dfToPlot[dfToPlot$clusters %in% c(2,3,6,7), ]$clusters.name <- "Directed"
dfToPlot[dfToPlot$clusters %in% c(5), ]$clusters.name <- "Meandering"
dfToPlot[dfToPlot$clusters %in% c(0,4), ]$clusters.name <- "Scanning"
dfToPlot[dfToPlot$clusters %in% c(1), ]$clusters.name <- "Clustering"
...
for (i in unique(datToPlot$pop)) {
  ...
  plot.p1(datToPlot, datToPlot %>% dplyr::filter(pop == i, Treatment == "HSV" & dpi == "1"))
  ggsave(file.path(anaDir, paste0("umap_HSV_1_", x, ".tiff")), width = 2, height = 2)
  
  plot.p1(datToPlot, datToPlot %>% dplyr::filter(pop == i, Treatment == "HSV" & dpi != "1"))
  ggsave(file.path(anaDir, paste0("umap_HSV_2_", x, ".tiff")), width = 2, height = 2)
}
```
...
summaryDF[summaryDF$clusters %in% c(2,3,6,7), ]$clusters.name <- "Directed"
summaryDF[summaryDF$clusters %in% c(5), ]$clusters.name <- "Meandering"
summaryDF[summaryDF$clusters %in% c(0,4), ]$clusters.name <- "Scanning"
summaryDF[summaryDF$clusters %in% c(1), ]$clusters.name <- "Clustering"
