...
hmmTime$hmm.type <- "1"
# hmmTime[hmmTime$live.cell.hmm.state.movement %in% c(2), ]$hmm.type <- "Immotile"
# hmmTime[hmmTime$live.cell.hmm.state.movement %in% c(3), ]$hmm.type <- "Other"
hmmTime[hmmTime$live.cell.track.clusters.default %in% c(2), ]$hmm.type <- "2"
hmmTime[hmmTime$live.cell.track.clusters.default %in% c(3), ]$hmm.type <- "3"
hmmTime[hmmTime$live.cell.track.clusters.default %in% c(4), ]$hmm.type <- "4"
hmmTime$hmm.type <- factor(hmmTime$hmm.type, levels = c("1", "2", "3", "4"))
