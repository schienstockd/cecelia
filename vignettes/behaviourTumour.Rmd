...
cciaObj <- initCciaObject(
  pID = pID, uID = "giJZjT", versionID = versionID, initReactivity = FALSE # Tumour
)

cciaObj$setImFilepath(paste0("ccidCorrected", ".zarr"), valueName = "corrected")
cciaObj$valueNames("imFilepath")
```
