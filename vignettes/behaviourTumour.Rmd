...
labels <- cciaObj$labelProps(valueName = "SHG.branch")
uns <- labels$values_uns()
labels$close()

paste(as.list(uns$ilee_summary), collapse = ", ")
paste(names(uns$ilee_summary), collapse = ", ")
...
```{r}
# get contacts of T cells with SHG
devtools::load_all("../")
cciaUse("~/cecelia/dev", initConda = FALSE, projectsDir = projectsDir)
...
# run task
funParams <- list(
  popsA = c("live.OTI/tracked"),
  popsB = c("labels.SHG.branch"),
  maxContactDist = 20
)
