...
baseChannels <- list(
  init = c(
    'CD45','CD11b','CD16','CD138','CD15','CD1a',
    'Cytokeratin','CD31','Podoplanin','Collagen-IV',
    'Vimentin','CD45RA','CD163','CD56','CD20',
    'Mast-cell-tryptase','CD11c','MUC-1','CD34',
    'CD45RO','CD68','CD57','CD38','CD3','CD4','CD8'
  ),
  CD4 = c(
...
clust <- list(
  init = c(
    'T','Tumor','Mphages','NK','B','Granulocytes','DC','Epithelia','BV',
    'Lymphatics','Stroma','CD4','CD8','Neutrophils','Vasculature',
    'Plasma cells','Other','Langerhans cells',
    "CD4.Tumor", "CD4.ae", "CD4.Treg", "CD4.naive", "CD4.GrB+", "CD4.ICOS+"),
...
ggplot(summaryDF,
  ...
  ylab("Region (%)") + xlab("") +
  facet_wrap(.~regions, ncol = 10, scales = "free_y") +
...
ggsave(file.path(anaDir, "regions_heat.pdf"), width = 8, height = 4)
```
