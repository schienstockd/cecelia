...
```{r}
anaDir <- "/Volumes/USER_data/Dominik/Experiments/Phillips2022_CODEX/CECELIA"
```
...
cciaObj <- initCciaObject(
  pID = pID, uID = "9qLcAF", versionID = versionID, initReactivity = FALSE
)
...
popDT <- cciaObj$popDT(
  ...
  pops = c("melano", "endothelial", "lymphs", "macro.mono", "macro.PDL1+"), uIDs = uIDs)
