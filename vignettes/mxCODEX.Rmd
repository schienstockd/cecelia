...
clusterChannels <- clusterChannels[!clusterChannels %in% c("DAPI-02", "HOECHST")]
...
# get colours
colPal <- randomcoloR::distinctColorPalette(length(unique(popDT$clusters)))
...
for (i in unique(regionsDT$uID)) {
  ...
  ggsave(file.path(anaDir, "maps", paste0("regions_", i, ".png")), width = 8, height = 8, plot = p1)
