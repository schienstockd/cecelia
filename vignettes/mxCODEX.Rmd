...
ggsave(file.path(anaDir, paste0("umap-", cciaObj$getUID(), ".png")), width = 4, height = 4, plot = p1)
# ggsave(file.path(anaDir, "umap-uids.png"), width = 40, height = 4, plot = p1)
