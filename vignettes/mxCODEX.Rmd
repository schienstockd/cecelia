...
ggsave(file.path(anaDir, paste("umap-", cciaObj$getUID(), ".tiff")), width = 4, height = 4, plot = p1)
# ggsave(file.path(anaDir, "umap-uids.tiff"), width = 30, height = 4, plot = p1)
# ggsave(file.path(anaDir, "umap_coating.tiff"), width = 2, height = 2)
# ggsave(file.path(anaDir, "umap_coating_treatment.tiff"), width = 4, height = 2.5)
```
...
ggsave(file.path(anaDir, "clusters_im.tiff"), width = 12, height = 5)
# }
```
...
for (i in unique(dfToPlot$uID)) {
  ...
  ggsave(file.path(anaDir, "maps", paste0("clusters_", i, ".tiff")), width = 12, height = 12, plot = p1)
