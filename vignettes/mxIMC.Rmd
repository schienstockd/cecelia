...
cciaObj$cciaObjects(uIDs = uIDs)[[1]]$popPaths("clust", includeFiltered = TRUE)
...
ggplot(markersSummary %>%
         ...
         dplyr::filter(!clusters %in% c(10)), aes(clusters, marker)) +
  theme_classic() +
...
ggsave(file.path(anaDir, "clusters_heat.pdf"), width = 9, height = 10)
```
