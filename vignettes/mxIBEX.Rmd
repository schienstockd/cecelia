...
cciaObj <- initCciaObject(
  pID = pID, uID = "Gal2rO", versionID = versionID, initReactivity = FALSE
)

popLabels <- cciaObj$labelProps("default")
popDT <- as.data.table(popLabels$as_df())
...
popDT <- cciaObj$popDT(
  ...
  pops = c("T", "B", "macro.dc", "endothelial", "lymphatic", "lymphs"),
