...
ggplot(branchDT %>% filter(
    centroid_x > 5000, centroid_x <= 7000,
    centroid_y > 5500, centroid_y <= 6000,
...
ggsave(file.path(anaDir, 'stroma', 'n22foC_branching_zoom.png'), plot = p1, height = 5, width = 20)
...
write.csv(summaryDT, file.path(anaDir, "stroma", "stroma_and_regions.csv"))
```
