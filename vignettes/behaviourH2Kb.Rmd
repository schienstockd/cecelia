...
propsToPlot[propsToPlot$clusters %in% c(1,2,4,5), ]$clusters.name <- "Directed"
propsToPlot[propsToPlot$clusters %in% c(3), ]$clusters.name <- "Meandering"
propsToPlot[propsToPlot$clusters %in% c(0,6), ]$clusters.name <- "Scanning"
