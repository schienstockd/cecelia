...
propsSummary[propsSummary$hmm_value == "1", ]$hmm_value <- "Arrested"
propsSummary[propsSummary$hmm_value == "2", ]$hmm_value <- "Directed"
propsSummary[propsSummary$hmm_value == "3", ]$hmm_value <- "Scanning"
propsSummary[propsSummary$hmm_value == "4", ]$hmm_value <- "Meandering"
...
datToPlot <- popDTs %>%
  ...
  dplyr::filter(!live.cell.track.clusters.hmm_movement %in% c(1,8)) %>%
