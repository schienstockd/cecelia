...
# data.table::fwrite(popDT.labels, file.path(anaDir, "pop.csv"))
# data.table::fwrite(DT, file.path(anaDir, "pop.csv"))
```
...
data.table::fwrite(summaryDT, file.path(anaDir, "aSf5Rr", "stroma_and_regions.csv"))
```
