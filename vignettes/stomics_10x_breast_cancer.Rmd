...
cciaObj$imChannelNames()[cciaObj$imChannelNames() == "POSTN"]
```
...
channelNames <- cciaObj$cciaObjects()[[1]]$imChannelNames()
channelNames <- unname(channelNames[channelNames != "Hoechst"])
uIDs <- c("aSf5Rr")
...
cciaObj$popDT("branch", pops = c("stroma.branch"), popCols = c("branching-type"))
```
