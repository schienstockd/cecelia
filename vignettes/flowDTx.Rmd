...
cciaObj <- initCciaObject(
  # pID = pID, uID = "2aPNfa", versionID = versionID, initReactivity = FALSE
  pID = pID, uID = "lPua3F", versionID = versionID, initReactivity = FALSE
)

cciaObj$popDT("flow", pops = c("/Lymphs/Singlets/Live/CD45/nonNK/T"),
              popCols = .flowCorrectChannelNames(c("FSC-A", "SSC-A")),
              completeDT = FALSE)
```
