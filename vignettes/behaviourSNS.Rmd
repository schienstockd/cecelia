...
dfToPlot[dfToPlot$clusters %in% c(1), ]$clusters.name <- "Directed"
dfToPlot[dfToPlot$clusters %in% c(0,3,5), ]$clusters.name <- "Meandering"
dfToPlot[dfToPlot$clusters %in% c(2), ]$clusters.name <- "Stopping"
dfToPlot[dfToPlot$clusters %in% c(4), ]$clusters.name <- "Arrested"
...
propsToPlot[propsToPlot$clusters %in% c(1), ]$clusters.name <- "Directed"
propsToPlot[propsToPlot$clusters %in% c(0,3,5), ]$clusters.name <- "Meandering"
propsToPlot[propsToPlot$clusters %in% c(2), ]$clusters.name <- "Stopping"
propsToPlot[propsToPlot$clusters %in% c(4), ]$clusters.name <- "Arrested"
...
speedTimeClusters[speedTimeClusters$live.cell.track.clusters.hmm_transitions_movement %in% c(1), ]$clusters.name <- "Directed"
speedTimeClusters[speedTimeClusters$live.cell.track.clusters.hmm_transitions_movement %in% c(0,3,5), ]$clusters.name <- "Meandering"
speedTimeClusters[speedTimeClusters$live.cell.track.clusters.hmm_transitions_movement %in% c(2), ]$clusters.name <- "Stopping"
speedTimeClusters[speedTimeClusters$live.cell.track.clusters.hmm_transitions_movement %in% c(4), ]$clusters.name <- "Arrested"
...
colPal <- randomcoloR::distinctColorPalette(
  length(unique(speedTimeClusters$live.cell.track.clusters.hmm_transitions_movement))
)
...
ggplot(speedTimeClusters %>%
  ...
  facet_wrap(.~uID_Treat, scales = "free_x")
  # expand_limits(y = 0)
...
ggsave(file.path(anaDir, "speed_time_clusters_treat.png"), height = 6, width = 10)
```
