...
See ['github answer'](https://github.com/dmlc/xgboost/issues/1715#issuecomment-438924721).
...
Otherwise add `export KMP_DUPLICATE_LIB_OK=TRUE` into `cecelia-macOSX.sh` before the line
`echo $R_CALL`.
