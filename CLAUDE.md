...
- [`docs/DEV.md`](docs/DEV.md) — development workflow: branch + PR conventions (never commit/push to `main`), commit style, how PRs are opened/merged (`gh pr create` → relay the PR URL; Dominik merges), and how releases are tagged off `main`.
