  ...
  <div class="uv">
    <div class="uv-ctrl cc-panel-controls cc-muted">
      ...
      <TeleportPopover v-model="optsOpen" :anchor="optsBtn" placement="bottom-start">
        <div class="uv-opts">
          <label class="uv-opt cc-muted" v-tooltip.top="'What the point colours encode'"><span>Colour by</span>
          ...
          <label v-if="colourBy === 'attribute'" class="uv-opt cc-muted" v-tooltip.top="'Image attribute mapped to colour'"><span>Colour attribute</span>
          ...
          <label class="uv-opt cc-muted" v-tooltip.top="'Split into one small panel per value'"><span>Facet by</span>
          ...
          <label v-if="facetBy === 'attribute'" class="uv-opt cc-muted" v-tooltip.top="'Image attribute the panels split on'"><span>Facet attribute</span>
