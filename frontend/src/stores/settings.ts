...
export const useSettingsStore = defineStore('settings', () => {
  ...
  // the model Kiwi turns run — same allow-list as the lab log's Ask Claude (`observer.models`)
