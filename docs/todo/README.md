...
| [`CLOUD_TENANCY_SCOPE.md`](CLOUD_TENANCY_SCOPE.md) | assessed and declined (2026-08-21) | Decision record, not a plan: cloud tenancy is not realistic. Keeps the measurements behind that call — network-hosted working store, headless viewer — so they need not be re-derived |
