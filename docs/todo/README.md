...
| [`CORRECTION_PLAN.md`](CORRECTION_PLAN.md) | P1+P4a built (#590); P2 Merge/Remove built with obs carry-over; P3 invalidation surface built (staleness report tasks emit QC warn + sidecar); Phase-4 cockpit raster brush open | Fix a wrong mask / wrong track in the browser correction cockpit and have the correction become the data everything downstream uses |
