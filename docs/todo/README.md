...
| [`CORRECTION_PLAN.md`](CORRECTION_PLAN.md) | P1+P4a built (#590); P2 Merge/Remove built minus obs carry-over (cockpit-driven, napari retired); P3 open | Fix a wrong mask / wrong track in the browser correction cockpit and have the correction become the data everything downstream uses |
