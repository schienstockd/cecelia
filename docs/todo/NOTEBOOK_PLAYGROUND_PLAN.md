...
>
> Origin: the `docs/archive/python-audit-report.md` *Notebooks* section + follow-up discussion. Grounded
...
- `docs/archive/python-audit-report.md` — Notebooks section (origin) + the Python-boundary context.
- `docs/archive/julia-port-watchlist.md` — the porting discipline this feature complements.
