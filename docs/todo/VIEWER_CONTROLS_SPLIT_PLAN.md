...
the existing task rail. The `WEB_VIEWER_PLAN.md` browser/offline split holds — the browser renderer
is interactive display only, the offline renderer draws movie frames offline.
