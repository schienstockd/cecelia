...
.taskManagerUI <- function(id) {
  ...
  tagList(
    box(
      ...
      dataTableOutput(ns("taskMonitorAll"))
      # tabsetPanel(
      #   id = ns("taskMonitor"),
      #   type = "tabs",
      #   selected = "all",
      #   tabPanel("all", value = "all", dataTableOutput(ns("taskMonitorAll"))),
      #   tabPanel("running", value = "running", dataTableOutput(ns("taskMonitorRunning"))),
      #   tabPanel("queued", value = "queued", dataTableOutput(ns("taskMonitorQueued"))),
      #   tabPanel("success", value = "success", dataTableOutput(ns("taskMonitorSuccess"))),
      #   tabPanel("failed", value = "failed", dataTableOutput(ns("taskMonitorFailed")))
      # )
    )
  )
}
