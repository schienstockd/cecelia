  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      managerConf = list(
        ...
        imageViewer = list(
          napariModule = "signal_analysis"
        ),
        task = list(
          funLabel = "Signal analysis method",
