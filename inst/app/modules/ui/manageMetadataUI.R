            ...
            fluidRow(
              column(
                ...
                fluidRow(
                  column(
                    6,
                    disabled(textInput(ns("singleValue"), NULL))
                  ),
                  column(
                    6,
                    disabled(actionButton(ns("assignSingleValue"), "Assign Value"))
                  )
                )
              )
            ),
            fluidRow(
              column(
                ...
                fluidRow(
                  column(
                    6,
                    disabled(textInput(ns("regexpValue"), NULL)),
                  ...
                  column(
                    6,
                    disabled(actionButton(ns("assignRegexpValue"), "Assign Regexp"))
                  )
                )
              )
            ),
