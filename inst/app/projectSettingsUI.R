    ...
    fluidRow(
      box(
        ...
        fluidRow(
          ...
          column(
            1,
            shinyjs::disabled(actionButton(ns("runHPCTask"), "Run"))
          ),
          column(
            1,
            shinyjs::disabled(actionButton(ns("cancelHPCTask"), "Cancel",
                         class = btnCLASS_IMPORTANT))
          )
        ),
        tags$hr(),
        fluidRow(
          column(12, verbatimTextOutput(ns("hpcOutput")))
        )
      ),
      box(
        ...
        fluidRow(
          column(
            3,
            shinyjs::disabled(actionButton(ns("setupLabServerTest"), "Test connection"))
          ),
          column(
            3,
