...
track measurements and individual `object` measurements. These clusters
can be compared in time which shows that cells first have `directed`
movement. After treatment, they `stop` and return to `meandering`
behaviour.
